...
try {
  ...
  const { ChatScreenSmartShoppingTimeline, getProductSelectionScrollPosition, scrollContainerToProductSelectionAnchor, shouldCorrectRecommendationStartScroll, resolveChatScrollOwnership, PRODUCT_SELECTION_SCROLL_OFFSET } = await load("/src/app/components/features/chat/ChatScreen.tsx");
  ...
  assert.deepEqual(resolveChatScrollOwnership({ remainingScroll: 24, manualScrollIntent: true }), { manualScrollIntent: true, shouldStickToBottom: false }, "최대 스크롤 근처에서 사용자가 위로 이동하면 바닥 추적을 즉시 해제");
