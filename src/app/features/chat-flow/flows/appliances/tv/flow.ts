...
const steps: FlowStep[] = [
  ...
  { id: "tv-summary", type: "assistant-message", message: "조건을 요약했어요.", buildMessage: (a) => `적용 조건: ${v(a, "screenSize")}인치, OS ${String(v(a, "os"))}, 패널 ${String(v(a, "panel"))}, ${v(a, "useDefaults") === "yes" ? "4K·2년 보증 필수" : "직접 선택 기준"}, 예산 ${Number(v(a, "budget")).toLocaleString("ko-KR")}원이에요.`, next: "tv-confirm" },
