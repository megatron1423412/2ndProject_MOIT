...
export default function CriteriaMatchList({ matched, unmatched, confirmationTitle = "미충족·확인 필요" }: { matched: string[]; unmatched: string[]; confirmationTitle?: string }) {
  return (
    <div className="grid gap-2 sm:grid-cols-2">
      ...
      <div className="rounded-lg bg-amber-50 p-3 dark:bg-amber-400/10">
        <p className="text-[11px] font-black text-amber-700 dark:text-amber-300">{confirmationTitle}</p>
